...
// The "Draft Shifts" tab's content — no backing endpoint yet, so this is
...
export function DraftShiftsPanel() {
  return (
    <View style={styles.section}>
      <Text style={styles.sectionTitle}>Draft Shifts</Text>
      <View style={styles.emptyCard}>
        <Text style={styles.emptyText}>Draft shifts are coming soon.</Text>
      </View>
    </View>
  );
}
